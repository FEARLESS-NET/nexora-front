      ...
      <div className="mx-auto max-w-6xl eightd-transform-style-3d">
        ...
        <div className="mb-8 animate-slide-in eightd-translate-z-20">
          <div className="mb-2 flex items-center gap-3">
            <div className="eightd-button eightd-interactive flex h-10 w-10 items-center justify-center rounded-xl border border-green-500/30 bg-green-500/10 animate-pulse-glow">
          ...
          <p className="mt-2 text-sm text-gray-400 font-mono eightd-translate-z-10">
        ...
        {/* Search */}
        <div
          className="mb-8 animate-slide-in eightd-translate-z-15"
        ...
        >
          <div className="relative">
            ...
            <input
              ...
              className="input-cyber w-full rounded-xl py-3 pl-12 pr-4 text-sm text-white placeholder-gray-500 font-mono eightd-interactive"
            />
          </div>
        </div>
        ...
        {filteredCompanies.length > 0 ? (
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 eightd-transform-style-3d">
            {filteredCompanies.map((company, index) => (
              ...
              >
                {/* Banner */}
                {company.banner ? (
                  <div className="relative h-32 overflow-hidden eightd-transform-style-3d">
                    <img
                      src={company.banner}
                      alt={company.name}
                  ...
                  <div className="relative h-32 overflow-hidden bg-gradient-to-br from-green-500/10 to-gray-900 eightd-transform-style-3d">
                    <div className="absolute inset-0 cyber-grid opacity-30 eightd-translate-z-5" />
                  </div>
                )}

                <div className="relative -mt-8 p-5 eightd-transform-style-3d">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="min-w-0 flex-1 eightd-translate-z-10">
                      <h3 className="text-sm font-semibold text-white transition group-hover:text-green-400 font-mono eightd-text-depth">
                        {company.name}
                      </h3>
                  ...
                  {company.openJobs && company.openJobs > 0 && (
                    <div className="mt-4 flex items-center justify-between eightd-translate-z-10">
                      <span className="text-sm text-gray-400 font-mono">
                        ...
                        open position
                        {company.openJobs > 1 ? "s" : ""}
                      </span>

                      <ArrowRight className="h-4 w-4 text-gray-500 transition group-hover:text-green-400 eightd-translate-z-5" />
                    </div>
                  )}
                </div>
              </Link>
          ...
          <div className="eightd-card-tilt glass-cyber rounded-2xl border border-dashed border-green-500/20 py-16 text-center animate-slide-in">
            <div className="eightd-button eightd-interactive mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-xl border border-green-500/30 bg-green-500/10 animate-pulse-glow">
              <Building2 className="h-8 w-8 text-green-400/50 eightd-translate-z-10" />
            </div>

            <p className="text-sm text-gray-500 font-mono eightd-translate-z-10">
